...
public class DetailActivity extends AppCompatActivity {
    ...
    private void getBundle() {
        ...
        addToCartBtn.setText("Adicionar no carrinho - R$" + Math.round(numberOrder * object.getPrice()));
        ...
        minusBtn.setOnClickListener(v -> {
            numberOrder = numberOrder - 1;
            numberOrderTxt.setText("" + numberOrder);
            addToCartBtn.setText("Adicionar no carrinho - $" + Math.round(numberOrder * object.getPrice()));
        });
